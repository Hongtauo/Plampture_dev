...
def get_roi_square_points(p_wrist: Tuple[float, float], 
                          ...
                          use_circumscribed: bool = False    # 是否使用外接矩形模式
...
def crop_and_save_roi(original_image: np.ndarray, roi_corners: List[Tuple[float, float]], output_path: Optional[str] = None) -> Optional[np.ndarray]:
